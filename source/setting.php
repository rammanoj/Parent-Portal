...
<button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#myModal3">change number</button>
  ...
  <div class="modal fade" id="myModal3" role="dialog">
    ...
    <div class="form-group">        
      ...
      <div class="container">
      <label class="control-label col-sm-10">date :  <?php $name = $row1['date']; echo $name;?></label>
 <div class="col-sm-offset-4 col-sm-2">
<button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#myModal4">change date</button>
      </div>
  <div class="modal fade" id="myModal4" role="dialog">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">
        <input class="form-control" placeholder="dd-mm-yyyy" name="date1">
      </div>
    </div>
	<input type="hidden" name="var" value="e">
    <div class="form-group">        
      <div class="col-sm-offset-4 col-sm-3">
        <button type="submit" class="btn btn-primary btn-block" onclick="goto()">change</button>
      </div>
  ...
  <div class="container">
 <div class="col-sm-offset-4 col-sm-2">
<button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#myModal5">Add</button>
      </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
           <form class="form-horizontal" action="setting1.php" method="POST">
    <div class="form-group">
      <label class="control-label col-sm-4">Enter student id:</label>
      <div class="col-sm-3">
        <input class="form-control" placeholder="enter student id" name="stuname">
      </div>
    </div>
	<input type="hidden" name="var" value="f">
    <div class="form-group">        
      <div class="col-sm-offset-4 col-sm-3">
        <button type="submit" class="btn btn-primary btn-block" onclick="goto()">Add</button>
      </div>
    </div>
	</form>
		  <div class="modal-footer">
